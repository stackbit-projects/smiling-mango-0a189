...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6000a189d5341900168787b2
...
To start editing your site, you can use the Sanity interface at https://smiling-mango-0a189.sanity.studio/.
...
Generated at `2021-01-14T19:56:09.749Z` by Stackbit version `0.3.42`.